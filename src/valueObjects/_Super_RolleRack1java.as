 ...
 * of this value object you may modify the generated sub-class of this class - RolleRack1java.as.
 */
...
[ExcludeClass]
public class _Super_RolleRack1java extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("com.fortunaglobal.model.RolleRack1java") == null)
            {
                flash.net.registerClassAlias("com.fortunaglobal.model.RolleRack1java", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _RolleRack1javaEntityMetadata;
    ...
    private var _internal_rolleRack1javaMaterial : valueObjects.RolleRack1javaMaterial;
    ...
    private var _internal_rolleRack1java : String;
    ...
    public function _Super_RolleRack1java()
    {
        _model = new _RolleRack1javaEntityMetadata(this);
    ...
    [Bindable(event="propertyChange")]
    public function get rolleRack1javaMaterial() : valueObjects.RolleRack1javaMaterial
    {
        return _internal_rolleRack1javaMaterial;
    }
    ...
    [Bindable(event="propertyChange")]
    public function get rolleRack1java() : String
    {
        return _internal_rolleRack1java;
    }
    ...
    public function set rolleRack1javaMaterial(value:valueObjects.RolleRack1javaMaterial) : void
    {
        var oldValue:valueObjects.RolleRack1javaMaterial = _internal_rolleRack1javaMaterial;
        if (oldValue !== value)
        {
            _internal_rolleRack1javaMaterial = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "rolleRack1javaMaterial", oldValue, _internal_rolleRack1javaMaterial));
        }
    }
    ...
    public function set rolleRack1java(value:String) : void
    {
        var oldValue:String = _internal_rolleRack1java;
        if (oldValue !== value)
        {
            _internal_rolleRack1java = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "rolleRack1java", oldValue, _internal_rolleRack1java));
        }
    }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _RolleRack1javaEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _RolleRack1javaEntityMetadata) : void
    {
        var oldValue : _RolleRack1javaEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
