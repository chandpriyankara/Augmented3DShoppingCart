 ...
 * of this value object you may modify the generated sub-class of this class - RoundRack1java.as.
 */
...
[ExcludeClass]
public class _Super_RoundRack1java extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("com.fortunaglobal.model.RoundRack1java") == null)
            {
                flash.net.registerClassAlias("com.fortunaglobal.model.RoundRack1java", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _RoundRack1javaEntityMetadata;

    /**
     * properties
     */
    private var _internal_scale : int;
    private var _internal_roundRack1java : String;
    ...
    private var _internal_roundRack1javaMaterial : valueObjects.RoundRack1javaMaterial;
    ...
    public function _Super_RoundRack1java()
    {
        _model = new _RoundRack1javaEntityMetadata(this);
    ...
    [Bindable(event="propertyChange")]
    public function get roundRack1java() : String
    {
        return _internal_roundRack1java;
    }
    ...
    [Bindable(event="propertyChange")]
    public function get roundRack1javaMaterial() : valueObjects.RoundRack1javaMaterial
    {
        return _internal_roundRack1javaMaterial;
    }
    ...
    public function set roundRack1java(value:String) : void
    {
        var oldValue:String = _internal_roundRack1java;
        if (oldValue !== value)
        {
            _internal_roundRack1java = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "roundRack1java", oldValue, _internal_roundRack1java));
        }
    }
    ...
    public function set roundRack1javaMaterial(value:valueObjects.RoundRack1javaMaterial) : void
    {
        var oldValue:valueObjects.RoundRack1javaMaterial = _internal_roundRack1javaMaterial;
        if (oldValue !== value)
        {
            _internal_roundRack1javaMaterial = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "roundRack1javaMaterial", oldValue, _internal_roundRack1javaMaterial));
        }
    }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _RoundRack1javaEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _RoundRack1javaEntityMetadata) : void
    {
        var oldValue : _RoundRack1javaEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
